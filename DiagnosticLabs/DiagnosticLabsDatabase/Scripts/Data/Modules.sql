...
--PATIENTS
SELECT TOP 1 @ModuleTypeId = Id FROM ModuleTypes WHERE ModuleTypeName = 'Patients'
IF NOT EXISTS (SELECT * FROM Modules WHERE ModuleName = 'Registration' AND ModuleTypeId = @ModuleTypeId)
BEGIN
    INSERT INTO Modules(Id, ModuleTypeId, ModuleName, HasCreate, HasView, HasEdit, HasDelete, HasSearch, HasPrint, HasShowList, Icon, SortOrder, IsActive)
    VALUES (1, @ModuleTypeId, 'Registration', 1, 1, 1, 1, 1, 1, 0, 'registration', 1, 1)
END
...
BEGIN
    INSERT INTO Modules(Id, ModuleTypeId, ModuleName, HasCreate, HasView, HasEdit, HasDelete, HasSearch, HasPrint, HasShowList, Icon, SortOrder, IsActive)
    VALUES (2, @ModuleTypeId, 'Payment', 1, 1, 1, 1, 1, 1, 0, 'payment', 1, 1)
END
...
BEGIN
    INSERT INTO Modules(Id, ModuleTypeId, ModuleName, HasCreate, HasView, HasEdit, HasDelete, HasSearch, HasPrint, HasShowList, Icon, SortOrder, IsActive)
    VALUES (23, @ModuleTypeId, 'Sales Report', 0, 1, 0, 0, 0, 1, 0, 'report', 1, 1)
END

IF NOT EXISTS (SELECT * FROM Modules WHERE ModuleName = 'Statement of Accounts' AND ModuleTypeId = @ModuleTypeId)
BEGIN
    INSERT INTO Modules(Id, ModuleTypeId, ModuleName, HasCreate, HasView, HasEdit, HasDelete, HasSearch, HasPrint, HasShowList, Icon, SortOrder, IsActive)
    VALUES (24, @ModuleTypeId, 'Statement of Accounts', 0, 1, 0, 0, 1, 1, 0, 'report', 2, 1)
END
