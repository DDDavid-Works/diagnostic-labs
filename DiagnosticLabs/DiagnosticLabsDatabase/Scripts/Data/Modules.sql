...
BEGIN
    INSERT INTO Modules(ModuleTypeId, ModuleName, HasCreate, HasView, HasEdit, HasDelete, HasSearch, HasPrint, HasShowList, HasShowSetDefaults, Icon, SortOrder, IsActive)
    VALUES (@ModuleTypeId, 'Patient Registrations', 1, 1, 1, 1, 1, 1, 0, 0, 'registration', 1, 1)
END

IF NOT EXISTS (SELECT * FROM Modules WHERE ModuleName = 'Patients' AND ModuleTypeId = @ModuleTypeId)
BEGIN
    INSERT INTO Modules(ModuleTypeId, ModuleName, HasCreate, HasView, HasEdit, HasDelete, HasSearch, HasPrint, HasShowList, HasShowSetDefaults, Icon, SortOrder, IsActive)
    VALUES (@ModuleTypeId, 'Patients', 1, 1, 1, 1, 1, 1, 0, 0, 'patients', 1, 1)
END

IF NOT EXISTS (SELECT * FROM Modules WHERE ModuleName = 'Companies' AND ModuleTypeId = @ModuleTypeId)
BEGIN
    INSERT INTO Modules(ModuleTypeId, ModuleName, HasCreate, HasView, HasEdit, HasDelete, HasSearch, HasPrint, HasShowList, HasShowSetDefaults, Icon, SortOrder, IsActive)
    VALUES (@ModuleTypeId, 'Companies', 1, 1, 1, 1, 1, 1, 0, 0, 'company', 3, 1)
END
...
BEGIN
    INSERT INTO Modules(ModuleTypeId, ModuleName, HasCreate, HasView, HasEdit, HasDelete, HasSearch, HasPrint, HasShowList, HasShowSetDefaults, Icon, SortOrder, IsActive)
    VALUES (@ModuleTypeId, 'Payment', 1, 1, 1, 1, 1, 1, 0, 0, 'payment', 1, 1)
END
...
BEGIN
    INSERT INTO Modules(ModuleTypeId, ModuleName, HasCreate, HasView, HasEdit, HasDelete, HasSearch, HasPrint, HasShowList, HasShowSetDefaults, Icon, SortOrder, IsActive)
    VALUES (@ModuleTypeId, 'Sales Report', 0, 1, 0, 0, 0, 1, 0, 0, 'report', 1, 1)
END

IF NOT EXISTS (SELECT * FROM Modules WHERE ModuleName = 'Statement of Accounts' AND ModuleTypeId = @ModuleTypeId)
BEGIN
    INSERT INTO Modules(ModuleTypeId, ModuleName, HasCreate, HasView, HasEdit, HasDelete, HasSearch, HasPrint, HasShowList, HasShowSetDefaults, Icon, SortOrder, IsActive)
    VALUES (@ModuleTypeId, 'Statement of Accounts', 0, 1, 0, 0, 1, 1, 0, 0, 'report', 2, 1)
END
