...
{
    public class LabResultsDefault : BaseModel, IDataErrorInfo
    {
        private long il_Id;
        private int? il_ModuleId;
        private string il_Defaults;
        ...
        {
            get { return il_Defaults; }
            set { il_Defaults = value; OnPropertyChanged("Defaults"); }
        }
