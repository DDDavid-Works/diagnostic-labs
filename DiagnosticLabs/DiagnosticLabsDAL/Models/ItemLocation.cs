...
{
    public class ItemLocation : BaseModel, IDataErrorInfo
    {
        private long il_Id;
        private string il_ItemLocationName;
        ...
        {
            get { return il_ItemLocationName; }
            set { il_ItemLocationName = value; OnPropertyChanged("ItemLocationName"); }
        }
        ...
        #region Validation
        private static readonly string[] ValidatedProperties = { "ItemLocationName" };
        ...
        private string GetValidationError(string columnName)
        {
            ...
            if (columnName == "ItemLocationName" && this.ItemLocationName.Trim() == string.Empty)
